#ifndef CORE_INCLUDE_BABY_BEAR_POSEIDON2_LDE_VEC_H_
#define CORE_INCLUDE_BABY_BEAR_POSEIDON2_LDE_VEC_H_
...
class LDEVec {
 public:
  ...
  void add(rust::Slice<TachyonBabyBear> lde, size_t cols);
...
#endif  // CORE_INCLUDE_BABY_BEAR_POSEIDON2_LDE_VEC_H_
