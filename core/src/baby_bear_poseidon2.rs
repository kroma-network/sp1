...
pub struct TachyonBabyBear(pub u32);

pub struct TachyonBabyBear4(
    pub TachyonBabyBear,
    pub TachyonBabyBear,
    pub TachyonBabyBear,
    pub TachyonBabyBear,
...
pub mod ffi {
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_commitment_vec.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_domains.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_duplex_challenger.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_fri_proof.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_lde_vec.h");

        type LDEVec;

        fn new_lde_vec() -> UniquePtr<LDEVec>;
        fn add(self: Pin<&mut LDEVec>, values: &mut [TachyonBabyBear], cols: usize);
    }

    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_opened_values.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_opening_points.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_opening_proof.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_prover_data_vec.h");
    ...
    unsafe extern "C++" {
        include!("sp1-core/include/baby_bear_poseidon2_two_adic_fri_pcs.h");
...
// NOTE: This is needed by `prove` function.
// See https://github.com/succinctlabs/sp1/blob/dd032eb/core/src/utils/prove.rs#L111.
unsafe impl Send for ffi::DuplexChallenger {}
...
// NOTE: This is needed by `DefaultProver` struct.
// See https://github.com/succinctlabs/sp1/blob/dd032eb/core/src/stark/prover.rs#L153.
unsafe impl Send for ffi::FriProof {}
unsafe impl Sync for ffi::FriProof {}
...
impl<Val> LDEVec<Val> {
    ...
    pub fn add(&mut self, values: &mut [Val], cols: usize) {
        self.inner
            .pin_mut()
...
// NOTE: This is needed by `DefaultProver` struct.
// See https://github.com/succinctlabs/sp1/blob/dd032eb/core/src/stark/prover.rs#L152.
unsafe impl Send for ffi::ProverData {}
unsafe impl Sync for ffi::ProverData {}
...
unsafe impl Send for ffi::ProverDataVec {}
unsafe impl Sync for ffi::ProverDataVec {}
...
unsafe impl Send for ffi::TwoAdicFriPcs {}
unsafe impl Sync for ffi::TwoAdicFriPcs {}
    ...
    Val: TwoAdicField,
{
    ...
    pub fn do_commit(&self, mut ldes: Vec<DenseMatrix<Val>>) -> ProverData<Val> {
        let mut lde_vec = LDEVec::new(ffi::new_lde_vec());
        for lde in ldes.iter_mut() {
            lde_vec.add(lde.values.as_mut_slice(), lde.width);
        }
